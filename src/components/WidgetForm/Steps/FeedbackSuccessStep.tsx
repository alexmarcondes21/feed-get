...
className="py-2 px-6 mt-6 bg-zinc-800 rounded-md border-transparent text-sm leading-6 hover:bg-zinc-700 transition-colors focus:outline-none scrollbar-thin scrollbar-thumb-zinc-700 scrollbar-track-transparent  focus:border-[#8257e6] focus:ring-[#8257e6] focus:ring-1 resize-none"
>
  Quero enviar outro
</button>
    </div>
